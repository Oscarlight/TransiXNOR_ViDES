...
# python device.py $version --vdsmin 0.25 --vdsmax 0.25 --vdsN 1 &
# python device.py $version --vdsmin 0.24 --vdsmax 0.24 --vdsN 1 & 
# python device.py $version --vdsmin 0.23 --vdsmax 0.23 --vdsN 1 
# python device.py $version --vdsmin 0.22 --vdsmax 0.22 --vdsN 1 &
# python device.py $version --vdsmin 0.21 --vdsmax 0.21 --vdsN 1 &
# python device.py $version --vdsmin 0.20 --vdsmax 0.20 --vdsN 1 &
# python device.py $version --vdsmin 0.19 --vdsmax 0.19 --vdsN 1 
# python device.py $version --vdsmin 0.18 --vdsmax 0.18 --vdsN 1 &
# python device.py $version --vdsmin 0.17 --vdsmax 0.17 --vdsN 1 &
# python device.py $version --vdsmin 0.16 --vdsmax 0.16 --vdsN 1 &
# python device.py $version --vdsmin 0.15 --vdsmax 0.15 --vdsN 1 
# python device.py $version --vdsmin 0.14 --vdsmax 0.14 --vdsN 1 &
# python device.py $version --vdsmin 0.13 --vdsmax 0.13 --vdsN 1 &
# python device.py $version --vdsmin 0.12 --vdsmax 0.12 --vdsN 1 &
# python device.py $version --vdsmin 0.11 --vdsmax 0.11 --vdsN 1 
